...
\newcommand{\myFigure}[2]{
	...
	% <br> forces caption (rendered as parbox image) below the figure:
...
%	\resizebox{#2}{!}{\includegraphics{eps/#1}}
	...
	% Raw <br> forces latex2html to put the (parbox-image) caption on a
	% new line below the figure instead of flowing inline to its right.
	\begin{rawhtml}<br>\end{rawhtml}
