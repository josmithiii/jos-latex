...
% Use the HTML-specific variant (no \parbox/\small) so latex2html renders
% the caption as text under the figure instead of a wide inline image:
\input{jos-latex/styles/mycaptionparlabel-html.tex}
