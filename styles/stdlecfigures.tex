...
\newcommand{\myFigureRotate}[3]{
	\begin{makeimage}
	\begin{center}
	\includegraphics[angle=#2]{eps/#1.eps} \\
	     #3
	\end{center}
	\end{makeimage}
}
...
\newcommand{\myFigureRotateToWidth}[4]{
	\begin{makeimage}
	\begin{center}
	\includegraphics[angle=#2,width=#3]{eps/#1.eps} \\
	     #4
	\end{center}
	\end{makeimage}
}
...
\newcommand{\myFigureRotateTwoToWidth}[5]{
	...
	\begin{center}
        \minipage{\twidth}
	  \includegraphics[angle=#3,width=#4]{eps/#1.eps}
	  \includegraphics[angle=#3,width=#4]{eps/#2.eps} \\
	     #5 % caption
        \endminipage
...
\newcommand{\myFigureRotateToBoxFIXME}[5]{
	\begin{makeimage}
	\begin{center}
	\includegraphics[angle=#2,width=#3,height=#4]{eps/#1.eps} \\
	     #5 % caption
	\end{center}
	\end{makeimage}
}
...
\newcommand{\myFigureToBox}[4]{
    \begin{makeimage}
    \begin{center}
    \includegraphics[width=#2,height=#3]{eps/#1.eps} \\
	#4
    \end{center}
    \end{makeimage}
}
...
%  	   \label{fig:#1}
	...
	\subfigure[#5]{ % Bot figure = 2nd figure
	   \includegraphics[width=#3]{eps/#2.eps}
%  	   \label{fig:#2}
	}
%	\caption{#6}
	\end{figure}
...
\newcommand{\myTwoFiguresToBoxes}[7]{
	...
	\subfigure[#5]{ % Top figure = first figure
	   \includegraphics[width=#3,height=#4]{eps/#1.eps}
  	   \label{fig:#1}
	}
	\subfigure[#6]{ % Bot figure = 2nd figure
	   \includegraphics[width=#3,height=#4]{eps/#2.eps}
  	   \label{fig:#2}
	}
%	\caption{#7}
	\end{figure}
