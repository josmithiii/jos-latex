...
\newcommand{\realpart}[1]{\mbox{re\ensuremath{\left\lbrace#1\right\rbrace}}}
\newcommand{\imagpart}[1]{\mbox{im\ensuremath{\left\lbrace#1\right\rbrace}}}
\newcommand{\realparttext}[1]{\mbox{re\ensuremath{\{#1\}}}}
\newcommand{\imagparttext}[1]{\mbox{im\ensuremath{\{#1\}}}}
\newcommand{\realPart}[1]{\mbox{re}\left\lbrace#1\right\rbrace}
\newcommand{\realPartSq}[1]{\mbox{re}^2\left\lbrace#1\right\rbrace}
\newcommand{\real}{\Re}
\newcommand{\imagPart}[1]{\mbox{im}\left\lbrace#1\right\rbrace}
\newcommand{\imagPartSq}[1]{\mbox{im}^2\left\lbrace#1\right\rbrace}
...
% Bold-letter matrix names:
%\newcommand{\mybm}{} % HACK!
\newcommand{\mybm}{\bm} % normal (bm.sty loaded above)
\newcommand{\Amtx}{\mathbf{A}}
...
\newcommand{\ztr}{Z transform} % Avoid markup so auto-link will work
